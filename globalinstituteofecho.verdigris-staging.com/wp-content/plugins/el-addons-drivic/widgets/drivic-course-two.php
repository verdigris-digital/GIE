...
* @since 1.0.0
**/
class Drivic_Course_Two extends Widget_Base {
	...
	**/
	...
	public function get_title() {
		return esc_html__( 'Drivic Course Two', 'drivic' );
	}
				...
				<?php if($course_query->have_posts()) : 
					while($course_query->have_posts()) : $course_query->the_post(); ?>
						...
						<div class="<?php echo $course_column ?> col-md-6">
		                    <div class="single-course-inner style-media">
		                        <div class="thumb">
		                            <?php
		                            $course_id = get_the_ID();
									echo get_the_post_thumbnail( null, 'drivic-blog-thumbnail-2', array('class'=> 'img-responsive') );	

									$price_html = '<div class="course-header-meta"><span class="price">'.__('Free', 'tutor').'</span></div>';
