; (function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.single-course-inner .details-inner .course-footer .course-author a', function (e) {
            e.preventDefault();
        })
    ...
    $(window).on("scroll", function() {
        ...
        if (scroll < 200) {
            $(".navbar").removeClass("sticky-activess");
        } else {
            $(".navbar").addClass("sticky-activess");
        }
