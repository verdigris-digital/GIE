...
<div class="tutor-price-preview-box-area">
    ...
    <div class="tutor-lead-info-btn-group">
        ...
        if ( $wp_query->query['post_type'] !== 'lesson') {
            ...
            if ( $lesson_url ) { ?>
                <a href="<?php echo esc_html($lesson_url); ?>" class="btn btn-base w-100">
                    <?php
                        if($completed_lessons){
                            _e( 'Continue to lesson', 'drivic' );
                        }else{
                            _e( 'Start Course', 'drivic' );
                        }
                    ?>
                </a>
            <?php }
    ...
    <div class="tutor-single-course-segment  tutor-course-enrolled-wrap">
        <p>
            ...
            <?php
                ...
                echo sprintf(__('You have been enrolled on %s.', 'drivic'),  "<span>". date_i18n(get_option('date_format'), strtotime($enrolled->post_date)
                    )."</span>"  );
                ?>
        </p>
