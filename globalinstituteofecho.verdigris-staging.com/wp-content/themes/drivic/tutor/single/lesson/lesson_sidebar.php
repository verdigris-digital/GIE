...
<?php do_action('tutor_lesson/single/before/lesson_sidebar'); ?>
    ...
    <div class="tutor-sidebar-tabs-wrap">
        <div class="tutor-tabs-btn-group">
            <a href="#tutor-lesson-sidebar-tab-content" class="<?php echo esc_html($enable_q_and_a_on_course) ? "active" : ""; ?>"> <i class="tutor-icon-education"></i> <span> <?php esc_html_e('Lesson List', 'drivic'); ?></span></a>
			<?php if($enable_q_and_a_on_course) { ?>
                <a href="#tutor-lesson-sidebar-qa-tab-content"> <i class="tutor-icon-question-1"></i> <span><?php esc_html_e('Browse Q&A', 'drivic'); ?></span></a>
			<?php } ?>
        </div>
        ...
        <div class="tutor-sidebar-tabs-content">
            ...
            <div id="tutor-lesson-sidebar-tab-content" class="tutor-lesson-sidebar-tab-item">
				...
				if ($topics->have_posts()){
					while ($topics->have_posts()){ $topics->the_post();
                        ...
                        <div class="tutor-topics-in-single-lesson tutor-topics-<?php echo esc_html($topic_id); ?>">
                            <div class="tutor-topics-title <?php echo esc_html($topic_summery) ? 'has-summery' : ''; ?>">
                                <h3>
									<?php
									the_title();
									if($topic_summery) {
                            ...
                            <div class="tutor-lessons-under-topic d-none">
								<?php
								...
								if ($lessons->have_posts()){
									while ($lessons->have_posts()){
										...
										if ($post->post_type === 'tutor_quiz') {
											$quiz = $post;
											?>
                                            <div class="tutor-single-lesson-items quiz-single-item quiz-single-item-<?php echo esc_html($quiz->ID); ?> <?php echo esc_html(( $currentPost->ID === get_the_ID() )) ? 'active' : ''; ?>" data-quiz-id="<?php echo esc_html($quiz->ID); ?>">
                                                <a href="<?php echo get_permalink($quiz->ID); ?>" class="sidebar-single-quiz-a" data-quiz-id="<?php echo esc_html($quiz->ID); ?>">
											...
											?>
                                            <div class="tutor-single-lesson-items assignments-single-item assignment-single-item-<?php echo esc_html($post->ID); ?> <?php echo esc_html(( $currentPost->ID === get_the_ID() )) ? 'active' : ''; ?>"
                                                 data-assignment-id="<?php echo esc_html($post->ID); ?>">
                                                <a href="<?php echo get_permalink($post->ID); ?>" class="sidebar-single-assignment-a" data-assignment-id="<?php echo esc_html($post->ID); ?>">
                                            ...
                                            <div class="tutor-single-lesson-items <?php echo esc_html(( $currentPost->ID === get_the_ID() )) ? 'active' : ''; ?>">
            ...
            <div id="tutor-lesson-sidebar-qa-tab-content" class="tutor-lesson-sidebar-tab-item tutor-lesson-sidebar-tab-item d-none">
				<?php
