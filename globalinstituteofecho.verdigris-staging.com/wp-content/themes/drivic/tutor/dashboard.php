...
?>
    ...
    <div class="tutor-wrap tutor-dashboard tutor-dashboard-student pd-top-120">
                        ...
                        <div class="tutor-dashboard-header-button">
                            ...
                            if(current_user_can(tutor()->instructor_role)){
                                ...
                                <a class="tutor-btn bordered-btn" href="<?php echo apply_filters('frontend_course_create_url', admin_url("post-new.php?post_type=".tutor()->course_post_type)); ?>">
                                    <?php echo sprintf(__('%s Add A New Course ', 'drivic'), '<i class="tutor-icon-checkbox-pen-outline"></i> &nbsp;'); ?>
                                </a>
                                <?php
                            }else{
                                if (tutils()->get_option('enable_become_instructor_btn')) {
                                    ...
                                    <a class="tutor-btn bordered-btn" href="<?php echo esc_url(tutils()->instructor_register_url()); ?>">
                                        <?php echo sprintf(__("%s Become an instructor", 'drivic'), '<i class="tutor-icon-man-user"></i> &nbsp;'); ?>
                                    </a>
                                    <?php
                                }
                            }
