...
<div class="tutor-single-lesson-wrap pd-top-120 <?php echo esc_html($enable_spotlight_mode) ? "tutor-spotlight-mode" : ""; ?>">
    <div class="tutor-lesson-sidebar">
        ...
        <div class="tutor-sidebar-tabs-wrap">
            <div class="tutor-tabs-btn-group">
                <a href="#tutor-lesson-sidebar-tab-content" class="active"> <i class="tutor-icon-education"></i> <span> <?php esc_html_e('Lesson List', 'drivic'); ?></span></a>
            </div>
                                ...
                                <div class="tutor-lessons-under-topic d-none">
								    ...
								    if ($lessons->have_posts()){
									    while ($lessons->have_posts()){ $lessons->the_post();
                                            ...
                                            <div class="tutor-course-lesson <?php echo ( esc_html($currentPost->ID) === get_the_ID() ) ? 'active' : ''; ?>">
                                                <h5>
												    <?php
